...
class _AppointmentPageState extends State<AppointmentPage> {
  ...
  bool _isPastTime(String timeString) {
    ...
    // Only gray out if the selected date is today
    if (selDate!.year == now.year && selDate!.month == now.month && selDate!.day == now.day) {
      try {
        ...
        // Combine the selected date with the parsed time from the button
        ...
        // Returns true if the slot is earlier than right now
            ...
            child: selDate == null
                ...
                : GridView.count(
                    ...
                    children: _generateTimeSlots(selDate).map((time) {
                      ...
                      bool isPassed = _isPastTime(time); // Use our new logic
                      ...
                      if (isBooked) {
                        ...
                        fgColor = Colors.grey.shade400; // Grayed out logic
